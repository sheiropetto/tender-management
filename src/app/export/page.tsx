  ...
  return (
    <div className="p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {/* Generate TOC */}
        <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:border-zinc-300 hover:shadow-md">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button className="inline-flex items-center gap-2 rounded-lg border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50">
      ...
      <div className="mt-8 rounded-xl border-2 border-dashed border-zinc-200 bg-white/50 p-16 text-center">
